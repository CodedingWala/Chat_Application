      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <div className="avatar online">
            ...
            >
            {uploadingImg ? <LoaderIcon className="w-full h-5 animate-spin text-center m-auto" /> : <img
        ...
        <div className="flex gap-4 items-center">
          ...
          <button
            ...
            onClick={() => {
              ...
              mouseClickSound.play().catch((error) => console.log("Audio play failed:", error.message));
              ToggleSound();
            }}
          >
            {IsSoundeEnabled ? (
